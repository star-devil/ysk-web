...
(function () {
    ...
    var data1 = ['600','500','1200','1600','1200','400','900','1100','2600','2400','1350','900','250'];
    var data2 = ['400','500','800','1400','1800','600','1100','900','2400','2600','1650','600','250'];
...
(function () {
    ...
    var data1 = ['450','1800','2600','2550','600','1600','5100','200','50'];
    var data2 = ['550','2200','2400','2450','400','1800','4900','300','50'];
    for (var i = 0; i < data.length; i++) {
        if (data[i] === '文盲') {
            data[i] = {
                value: '文盲',
...
//家庭结构
(function () {
    var colorList =['#228c38', '#b04b07', '#af8108', '#f39c12'];
    var colorListSub =['rgba(35,143,56,.5)', 'rgba(176,75,7,.5)', 'rgba(175,129,8,.5)','rgba(243,156,18,.5)'];
                ...
                series: [
                    {
                        ...
                        data:[
                            {value:data['singleParent'], name:'单亲'},
                            {value:data['mainFamily'], name:'主干'},
                            {value:data['uniteFamily'], name:'联合'},
                            {value:data['otherFamily'], name:'其他'},
                            // {value:data['otherFamily'], name:'其他'}
                        ]
                    },
                    // 中心的圆圈
                    ...
                    series: [
                        {
                            ...
                            data:[
                                {value:data['spinsterhoodCount'], name:'未婚'},
                                {value:data['marriedCount'], name:'已婚'},
                                {value:data['divorceCount'], name:'离婚'},
                                {value:data['remarryCount'], name:'再婚'},
                                {value:data['widCount'], name:'丧偶'}
                            ]
                        },
                        // 边框的设置
                        {
